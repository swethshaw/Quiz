        ...
        <nav className="flex-1 overflow-y-auto px-4 py-4 space-y-5 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-800">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-300 ${openMenus.lms ? "rotate-180" : ""}`}
              />
            </button>
            {openMenus.lms && (
              <div className="space-y-1 animate-in slide-in-from-top-1 duration-200">
                <SubLink
                  ...
                  onClick={(e: React.MouseEvent) => {
                    e.preventDefault(); // Prevents navigating to a broken /course route
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-300 ${openMenus.quiz ? "rotate-180" : ""}`}
              />
            </button>
            {openMenus.quiz && (
              <div className="space-y-1 animate-in slide-in-from-top-1 duration-200">
...
const SubLink = ({ to, label, icon: Icon, onClick }: any) => (
  <NavLink
    to={to}
    onClick={onClick}
    className={({ isActive }) => `
